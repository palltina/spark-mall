package com.atguigu.sparkmall.mork.mocker

import java.text.SimpleDateFormat
import java.util.UUID

import com.atguigu.sparkmall.commen.bean.{CityInfo, ProductInfo, UserInfo, UserVisitAction}
import com.atguigu.sparkmall.mork.util.{RanOpt, RandomDate, RandomNum, RandomOptions}
